# -*- coding: utf-8 -*-
"""
Created on Wed Jan 30 20:43:16 2019

@author: jmat

Description:
A Program to keep track of books in Library
Title,Author
Year, ISBN
...
b1=Button(window,text="View All Entries", width=12,command=view_command)
...
b6=Button(window,text="Close Window", width=12,command=window.destroy)
